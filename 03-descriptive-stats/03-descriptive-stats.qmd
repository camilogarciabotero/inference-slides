...
```
1. This argument replaces the `group_by` verb avoiding one pipe step
2. Here we will iterate through all the columns that that satisfy the condition `is.numeric`.
